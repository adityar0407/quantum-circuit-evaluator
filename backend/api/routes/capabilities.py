...
def resource_estimation_capabilities() -> dict:
    ...
    return {
        ...
        "native_operations": ["BARRIER", "CX", "H", "MEASURE", "RESET", "RX", "RY", "RZ", "S", "SDG", "T", "TDG", "X", "Z"],
    }
...
def _load_qre_capabilities() -> tuple[dict, list[str]]:
    try:
    ...
    return physical_profile_capabilities(), sorted(QDK_QEC_MODELS)
