...
def build_qre_params(
    ...
    assumptions = {
        ...
        "qre_qec_profile_mode": getattr(qec, "qre_profile_mode", "azure_builtin"),
        ...
        "current_qre_limitation": (
            "The installed QDK Qiskit interface estimates a gate-based QuantumCircuit reconstructed from LogicalIR."
        ),
        "future_native_qre_flow": "LogicalIR -> native QRE Trace -> QRE estimate",
        ...
        "translation_notes": [
            ...
            "Remote and inter-node operations remain explicit LogicalIR operations and are lowered to their base logical gate only for Azure QRE circuit submission.",
...
def _apply_custom_qec_scheme(params: EstimatorParams, qec: Any) -> dict[str, Any]:
    if getattr(qec, "qre_profile_mode", None) != "custom":
        return {}
